		...
		while($data = mysqli_fetch_assoc($sql)){
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?hal=detailbarang&kd=<?php echo $data['id_produk'];?>" class="btn btn-lg btn-danger">Detail</a>  <a href="detail.php" class="btn btn-lg btn-success">Beli &raquo;</a></div>
